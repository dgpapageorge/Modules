...
PHONE_LOCAL_VALIDATION.txt records local preflight checks for the exact packed files.
PHONE_TEST_RESULTS.md is a fill-in template for recording phone-side results.
After testing, copy PHONE_TEST_RESULTS.md back and run tools/validate-phone-results.mjs against it.
SHA256SUMS.txt contains transfer-check hashes for every numbered .txt file.
